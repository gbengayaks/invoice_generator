const countriesAndCurrencySymbols = [
  ...
  { country: 'Congo (Congo-Brazzaville)', currency: 'XAF', symbol: 'FCFA' },
  { country: 'Congo (DRC)', currency: 'CDF', symbol: 'FC' },
  ...
  { country: 'Kyrgyzstan', currency: 'KGS', symbol: 'с' },
  ...
  { country: 'Tajikistan', currency: 'TJS', symbol: 'SM' },
  ...
  { country: 'Trinidad and Tobago', currency: 'TTD', symbol: '$' },
  ...
  { country: 'Uzbekistan', currency: 'UZS', symbol: 'сўм' },
  { country: 'Vanuatu', currency: 'VUV', symbol: 'VT' },
  { country: 'Vatican City', currency: 'EUR', symbol: '€' },
  { country: 'Venezuela', currency: 'VES', symbol: 'Bs.S' },
  { country: 'Vietnam', currency: 'VND', symbol: '₫' },
  { country: 'Yemen', currency: 'YER', symbol: '﷼' },
  { country: 'Zambia', currency: 'ZMW', symbol: 'K' },
  { country: 'Zimbabwe', currency: 'ZWL', symbol: '$' },
];

//console.log(countriesAndCurrencySymbols);

export default countriesAndCurrencySymbols
